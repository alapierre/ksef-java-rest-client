...
public class InvoicePayloadType {
  /**
  ...
  public enum PayloadTypeEnum {
    ...
    public static PayloadTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<PayloadTypeEnum> {
      ...
      public PayloadTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return PayloadTypeEnum.fromValue((String)(value));
      }
    }
  ...
  public InvoicePayloadType() {
    this.payloadType = PayloadTypeEnum.valueOf(this.getClass().getSimpleName());
  }
  public InvoicePayloadType payloadType(PayloadTypeEnum payloadType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InvoicePayloadType invoicePayloadType = (InvoicePayloadType) o;
    return Objects.equals(this.payloadType, invoicePayloadType.payloadType);
  }
  ...
  public String toString() {
    ...
    sb.append("class InvoicePayloadType {\n");
